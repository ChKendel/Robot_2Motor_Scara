...
WS_URL = "wss://jetsonmini-simulationscara.schooltech.ch/echo"
USER = "abc"
PASS = "abc"
...
def main():
    ...
    ws = websocket.create_connection(WS_URL, header=[f"Cookie: SESSIONID={sid}"], suppress_origin=True)
    print(ws.recv())          # Begrüssung
    ws.send("simNr=0")
    print(ws.recv())          # Quittung
